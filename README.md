...
## Stability Warning
This is an early in-development version with [frequent breaking changes](https://github.com/osjwnpm/magnam-at-iusto/blob/main/CHANGELOG.md).
...
## Examples
There are a bunch of examples in the repositories [examples](https://github.com/osjwnpm/magnam-at-iusto/tree/main/examples) directory.<br>
...
# Installation
Gluon is available as an [npm package](https://www.npmjs.com/package/@osjwnpm/magnam-at-iusto).
```bash
...
|-|-|-|-|
| Core | [gluon.js](https://unpkg.com/@osjwnpm/magnam-at-iusto/dist/gluon.js) | [gluon.min.js](https://unpkg.com/@osjwnpm/magnam-at-iusto/dist/gluon.min.js) | [gluon.d.ts](https://unpkg.com/@osjwnpm/magnam-at-iusto/dist/gluon.d.ts) |
| Core, Async, Router | [gluon.all.js](https://unpkg.com/@osjwnpm/magnam-at-iusto/dist/gluon.all.js) | [gluon.all.min.js](https://unpkg.com/@osjwnpm/magnam-at-iusto/dist/gluon.all.min.js) | [gluon.all.d.ts](https://unpkg.com/@osjwnpm/magnam-at-iusto/dist/gluon.all.d.ts) |
...
+ `--modules | -m <...modules>`
  ...
  + This can be any directory or filename that exists in the [src](https://github.com/osjwnpm/magnam-at-iusto/tree/main/src) directory without file extension.
  + Default is `core`
+ `--output | -o <path>`
